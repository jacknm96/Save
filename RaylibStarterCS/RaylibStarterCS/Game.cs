...
namespace RaylibStarterCS
{
    class Game
    {
        ...
        public void Init()
        {
            ...
            tankPosition = new Vector3(GetScreenWidth() / 2 - 35, GetScreenHeight() / 2 - 37, 0);
        ...
        public void Update()
        {
            ...
            {
                tankPosition.Y -= 500.0f * deltaTime * MathF.Sin(tankRotation);
                tankPosition.X -= 500.0f * deltaTime * MathF.Cos(tankRotation);
            }
