...
namespace MathClasses
{
    public class Matrix4
    {
        ...
        public Matrix4(float m1, float m2, float m3, float m4, float m5, float m6, float m7, float m8, float m9, float m101, float m111, float m121, float m131, float m14, float m15, float m16)
        {
            m00 = m1; m01 = m5; m02 = m9; m03 = m131;
            m10 = m2; m11 = m6; m12 = m101; m13 = m14;
            m20 = m3; m21 = m7; m22 = m111; m23 = m15;
            m30 = m4; m31 = m8; m32 = m121; m33 = m16;
        }
        ...
        {
            return this * new Matrix4(new Vector4(1, 0, 0, 0), new Vector4(0, (float)Math.Cos(a), -(float)Math.Sin(a), 0), new Vector4(0, (float)Math.Sin(a), (float)Math.Cos(a), 0), new Vector4());
        }

        public Matrix4 SetRotateY(float a)
        {
            return this * new Matrix4(new Vector4((float)Math.Cos(a), 0, (float)Math.Sin(a), 0), new Vector4(0, 1, 0, 0), new Vector4(-(float)Math.Sin(a), 0, (float)Math.Cos(a), 0), new Vector4());
        }

        public Matrix4 SetRotateZ(float a)
        {
            return this * new Matrix4(new Vector4((float)Math.Cos(a), -(float)Math.Sin(a), 0, 0), new Vector4((float)Math.Sin(a), (float)Math.Cos(a), 0, 0), new Vector4(0, 0, 1, 0), new Vector4());
        }
